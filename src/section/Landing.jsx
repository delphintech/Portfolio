export default function Landing() {
  return (
    <div className="animate-blurred-fade-in relative flex flex-col flex-wrap justify-center items-center w-full h-full text-back-3 text-shadow-xs text-center z-10 ">
